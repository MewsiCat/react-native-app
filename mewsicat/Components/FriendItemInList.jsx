...
export default function FriendItemInList({ profilePicture, name, active }) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* <TouchableOpacity style={styles.sendMusicButton}>
        <Text style={styles.sendMusicButtonText} onPress={async () =>{toggleLoad(); await sendFriendRequest(name); toggleLoadFalse();}}>Send</Text>
      </TouchableOpacity> */}
    </View>
  );
}
